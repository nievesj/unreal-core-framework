...
void FBUITweenInstance::Begin()
{
	...
	{
		PaddingProp.OnBegin(FVector4(HorizontalBoxSlot->GetPadding().Left, HorizontalBoxSlot->GetPadding().Top, HorizontalBoxSlot->GetPadding().Bottom, HorizontalBoxSlot->GetPadding().Right));
	}
	else if (VerticalBoxSlot)
	{
		PaddingProp.OnBegin(FVector4(VerticalBoxSlot->GetPadding().Left, VerticalBoxSlot->GetPadding().Top, VerticalBoxSlot->GetPadding().Bottom, VerticalBoxSlot->GetPadding().Right));
	}
